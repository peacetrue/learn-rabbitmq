...
import static com.github.peacetrue.learn.rabbitmq.CommonUtils.getDeadLetter;
...
public class Receiver {
    ...
    public static void main(ConnectionFactory factory) throws IOException, TimeoutException {
        ...
        //独占模式，持久属性无用
        channel.queueDeclare(CommonUtils.DEMO_QUEUE_NAME, true, true, true, getDeadLetter());
